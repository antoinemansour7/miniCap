...
export const getMetroLineColor = (lineName) => {
...
export const fetchRouteData = async (start, end, mode) => {
    try {
...
export const detectTransferPoint = (steps, index, decodedStep, currentLine) => {
