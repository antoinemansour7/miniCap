...
with_node \
  ...
  --target "/Users/antoinemansour/Documents/Projects/miniCap/FindMyClass/ios/Pods/Target Support Files/Pods-FindMyClass/ExpoModulesProvider.swift" \
  --entitlement "/Users/antoinemansour/Documents/Projects/miniCap/FindMyClass/ios/FindMyClass/FindMyClass.entitlements" \
  --platform "apple" \
  --packages "expo" "expo-asset" "expo-blur" "expo-constants" "expo-file-system" "expo-font" "expo-haptics" "expo-keep-awake" "expo-linking" "expo-location" "expo-router" "expo-splash-screen" "expo-symbols" "expo-system-ui" "expo-web-browser"
